...
import 'package:sadan/pages/user/vehicle/user_reviews.dart';

import '../../../components/vechicle_info_widget.dart';

class userVehichleInfoScren extends StatelessWidget {
  late VehicleInfoController controller;
  userVehichleInfoScren(int id) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        VehicleDetailWidget(Icons.verified, 'Verified Status',
                            '${controller.info['approval'] == 1 ? "Verified" : "Unverified"}'),
                        VehicleDetailWidget(
